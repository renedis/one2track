...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    for device in devices:
        ...
        sensors.extend([
            ...
            One2TrackSensor(coordinator, device, "accuracy", f"{name_prefix} GPS accuracy", "m", "distance"),
...
class One2TrackSensor(CoordinatorEntity, SensorEntity):
    def __init__(self, coordinator, device, attribute, name, unit=None, device_class=None):
